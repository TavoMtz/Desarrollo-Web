...
checkAccess("0"); // Only allow administrators (role "2")
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <style>
        ...
        * {
        ...
        .category-container {
            width: 90%;
            /* Reduce width to leave space on the edges */
        ...
        .category-title {
            ...
            /* Center the text */
            color: white;
            /* Make the text color white for better contrast */
        ...
        .cart-container {
            ...
            top: 120px;
            width: 500px;
            /* Increased width to accommodate longer product names */
            max-width: 500px;
            /* Ensure it doesn't grow beyond this width */
            box-sizing: border-box;
        ...
        .cart-item {
            ...
            /* Adjust columns for image, name, and controls */
            align-items: center;
            gap: 10px;
        ...
        .quantity-controls {
            ...
            justify-content: space-between;
            gap: 10px;
            /* Add spacing between buttons and price */
        }
        ...
        .quantity-controls p {
            ...
            min-width: 60px;
            /* Ensure enough space for larger numbers */
        }
...
<body>
    ...
    <header class="header">
        ...
        <a class="headerButton" href="../../VistaUsuarios/aboutus.php">Acerca de Nosotros</a>
        <a class="headerButton" href="../../VistaUsuarios/promok.php">Promos de Temporada</a>
    </header>
